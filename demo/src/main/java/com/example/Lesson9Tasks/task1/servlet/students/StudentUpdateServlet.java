...
@WebServlet(
        name = "com.example.Lesson9Tasks.task1.servlet.student.StudentUpdateServlet",
...
public class StudentUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/students/update.jsp");
